      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-white ">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                <div className="mx-auto">
                  <svg
                    className="shrink-0 w-5  text-gray-500 transition duration-75 group-hover:text-gray-900"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="4 1 17 20"
            ...
            <li>
              <a href="/dashboard/rankings" className="flex items-center p-2 ">
                <svg
                  className="shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            id="dropdown-cta"
            className="p-4 mt-6 rounded-lg bg-blue-50"
            role="alert"
          >
            <div className="flex items-center mb-3">
              <span className="bg-orange-100 text-orange-800 text-sm font-semibold me-2 px-2.5 py-0.5 rounded-sm">
                Beta
              </span>
              <button
                type="button"
